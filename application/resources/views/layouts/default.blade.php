                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto navmenu">
                            ...
                            <li class="nav-item">
                                <div class="ui pointing link dropdown item" tabindex="0">
                                    <i class="ui icon linkify"></i> <span class="navmenutext uppercase">{{ __('Atalhos') }}</span>
                                    <i class="dropdown icon"></i>
                                    <div class="menu" tabindex="-1">
                                        <a href="{{ url('clock') }}" target="_blank" class="item"><i class="ui icon clock outline"></i>{{ __('Registro Web') }}</a>
                                        <div class="divider"></div>
                                        <a href="{{ url('employees/new') }}" class="item"><i class="ui icon user plus"></i>{{ __('Novo Funcionário') }}</a>
                                        <div class="divider"></div>
                                        <a href="{{ url('fields/company') }}" class="item"><i class="ui icon university"></i>{{ __('Empresa') }}</a>
                                        <a href="{{ url('fields/department') }}" class="item"><i class="ui icon cubes"></i>{{ __('Departamento') }}</a>
                                        <a href="{{ url('fields/jobtitle') }}" class="item"><i class="ui icon pencil alternate"></i>{{ __('Cargo') }}</a>
                                        <a href="{{ url('fields/leavetype') }}" class="item"><i class="ui icon calendar alternate outline"></i>{{ __('Afastamentos') }}</a>
                                    </div>
                                </div>
                            </li>
                            <li class="nav-item">
