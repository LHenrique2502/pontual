...
@section('meta')
<title>Departamento | Pontual</title>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <h2 class="page-title uppercase">{{ __("Incluir Departamentos") }}
            ...
            <div class="box box-success">
                <div class="box-body">
                    ...
                    <form id="add_department_form" action="{{ url('fields/department/add') }}" class="ui form" method="post" accept-charset="utf-8">
                        @csrf
                        <div class="field">
                            <label>{{ __("Nome do Departamento") }} <span class="help">e.g. "Accounting"</span></label>
