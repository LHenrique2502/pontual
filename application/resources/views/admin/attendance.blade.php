...
<div class="container-fluid">
    <div class="row">
        <h2 class="page-title">{{ __('Registros de ponto') }}
            <a href="{{ url('clock') }}" target="_blank" class="ui positive button mini offsettop5 float-right"><i class="ui icon clock"></i>{{ __('Abrir relógio web') }}</a>
            <button class="ui primary button mini offsettop5 btn-add float-right"><i class="ui icon plus circle"></i>{{ __("Registro manual") }}</button>
        </h2>
    </div>
                ...
                <form action="{{ url('export/report/attendance') }}" method="post" accept-charset="utf-8" class="ui small form form-filter" id="filterform">
                    ...
                    <div class="inline three fields">
                        <div class="two wide field">
                            <input id="datefrom" type="text" name="datefrom" value="" placeholder="Data inicial" class="airdatepicker">
                            <i class="ui icon calendar alternate outline calendar-icon"></i>
                        </div>

                        <div class="two wide field">
                            <input id="dateto" type="text" name="dateto" value="" placeholder="Data final" class="airdatepicker">
                            <i class="ui icon calendar alternate outline calendar-icon"></i>
                        </div>
